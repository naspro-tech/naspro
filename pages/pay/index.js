...
export default function HostedEasypaisaPortal() {   
  ...
  return (     
    <div className="page-bg">       
      ...
      <style jsx>{`         :root {           --card-w: 96%;           --max-w: 420px;         }          .page-bg {           min-height: 100vh;           display: flex;           align-items: center;           justify-content: center;           padding: 12px;           background: linear-gradient(45deg, #0b1220, #072540, #2b0f3a, #1f2937);           background-size: 600% 600%;           animation: bgShift 1s linear infinite;         }         @keyframes bgShift {           0% { background-position: 0% 50%; }           50% { background-position: 100% 50%; }           100% { background-position: 0% 50%; }         }          .card {           width: var(--card-w);           max-width: var(--max-w);           border-radius: 14px;           background: #fff;           box-shadow: 0 12px 36px rgba(2,6,23,0.5);           display: flex;           flex-direction: column;           overflow: hidden;         }          /* ===== Logo banner (full-width, exact height 120px) ===== */         .logo-banner {           height: 120px; /* exact requested height */           display: flex;           align-items: center;           justify-content: center;           background: #fff;         }         .logo-banner img {           width: 100%;           height: 100%;           object-fit: cover; /* banner fill */           display: block;         }          .body {           padding: 14px;         }          .welcome {           text-align: center;           font-size: 1.25rem;           font-weight: 700;           margin: 6px 0 8px;           color: #0f172a;         }          .instruction {           text-align: center;           font-size: 0.95rem;           color: #374151;           margin-bottom: 10px;           line-height: 1.45;         }          /* ===== fields layout - stacked, equal width, no overlap ===== */         .fields {           display: grid;           grid-template-columns: 1fr;           gap: 10px;           margin-bottom: 8px;         }         .field label {           display: block;           font-size: 0.85rem;           color: #111827;           margin-bottom: 6px;           text-align: left;         }         .field input {           width: 100%;           padding: 10px 12px;           border-radius: 8px;           border: 1px solid #d1d5db;           font-size: 1rem;           box-sizing: border-box;           text-align: center;           background: #fff;         }          .submit {           width: 100%;           padding: 12px;           border-radius: 10px;           border: none;           background: linear-gradient(90deg, #047857, #0ea5a6);           color: #fff;           font-weight: 700;           font-size: 1rem;           cursor: pointer;         }          .session-timer {           margin-top: 10px;           text-align: center;           font-weight: 600;           color: #0f172a;           background: linear-gradient(90deg, #111827, #1f2937);           padding: 8px 10px;           border-radius: 8px;           color: white;         }          /* Guide / approval message */         .guide h2 {           margin: 0 0 8px 0;         }         .approval {           direction: rtl;           text-align: center;           line-height: 1.6;           font-size: 1rem;           color: #065f46;         }         .note {           margin-top: 8px;           color: #374151;           font-size: 0.95rem;         }          /* Success */         .success h2 { margin-top: 0; }         .success-msg { color: #14532d; font-weight: 600; }         .closing { margin-top: 8px; font-weight: 700; }          .close-btn {           margin-top: 10px;           width: 100%;           padding: 10px;           border-radius: 8px;           border: none;           background: #111827;           color: white;           font-weight: 700;           cursor: pointer;         }          .expired h2 { margin-top: 0; }          @media (max-width: 360px) {           .card { max-width: 360px; }           .logo-banner { height: 110px; }           .welcome { font-size: 1.1rem; }           .instruction { font-size: 0.9rem; }           .field input { padding: 9px; font-size: 0.95rem; }           .submit { padding: 10px; font-size: 0.95rem; }           .session-timer { padding: 6px; font-size: 0.9rem; }         }       `}</style>     
    </div>   
  ); 
    }
